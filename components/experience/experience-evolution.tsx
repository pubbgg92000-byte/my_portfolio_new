...
const timeline = [
  ...
  },
  {
    ...
    skills: ["Prompt Engineering", "AI Workflows", "Agent Design", "LLM Integration"],
    icon: Cpu,
  },
  {
    year: "2026",
    ...
    place: "Current focus",
    type: "AI agents, SaaS products, developer tools",
    body: "Building AI agents, automation systems, SaaS products, developer tools, and interactive portfolios with a stack centered on Next.js, React, Node.js, GSAP, Three.js, Prisma, Docker, and AI workflows.",
    skills: ["AI Agents", "Automation Systems", "SaaS Products", "Developer Tools", "Interactive Portfolios"],
    current: true,
    icon: Bot,
  },
] as const;
